...
class BarChartSample1State extends State<BarChartSample1> {
      ...
      barRods: [
        BarChartRodData(
          ...
          borderSide: isTouched
              ? const BorderSide(color: Colors.grey)//widget.touchedBarColor.gr(80))
              : const BorderSide(color: Colors.white, width: 0),
          backDrawRodData: BackgroundBarChartRodData(
              show: true,
              toY: 20,
              color: Colors.grey.shade200 //widget.barBackgroundColor,
          ),
        ),
      ],
  ...
  List<BarChartGroupData> showingGroups() => List.generate(7, (i) {
    switch (i) {
      ...
      case 1:
        return makeGroupData(1, 19, isTouched: i == touchedIndex);
      case 2:
